          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a
                ...
                :class="{
                  'hover:text-white text-white bg-violet-600' : tab == 'login',
                  'hover:text-violet-600' : tab === 'register'}"
                href="#"
            ...
            <li class="flex-auto text-center">
              <a
                class="block rounded py-3 px-4 transition"
                :class="{
                  'hover:text-white text-white bg-violet-600' : tab == 'register',
                  'hover:text-violet-600' : tab === 'login'}"
                href="#"
